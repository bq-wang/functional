module CompilationInterpretation
// what we will cover int his chapter include the following 
//   1. when to do the compilation and interpretation
//   2. we will show you an example to show you that you can compare the compilation and interpretation vs. each other 
...
let interpretFlag = Console.ReadLine()
...
match interpretFlag with 
    ...
    | "cd" ->
        ...
        for i = 1 to reps do 
            ...
            | :? Df4 as d -> d.Invoke(args.[0], args.[1], args.[2], args.[3]) |> ignore 
            | _ -> failwith "too many parameters"
        clock.Stop()
        printf "%i" clock.ElapsedTicks
