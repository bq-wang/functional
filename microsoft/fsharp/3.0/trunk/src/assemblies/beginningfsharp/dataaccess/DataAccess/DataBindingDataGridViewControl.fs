module DataBindingDataGridViewControl

// in this chapter we will introduce the following 
//  1. how to do databindign with DataGridView control  with the DataSet
...
let dataSet = createDataSet "select top 10 * From Contact"
